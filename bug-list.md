...
2. I changed the for loop again because after thinking, it actually didn't make sense to assign the arrays to each other. Fixed a problem where the score would show "0" for the first correct question and now it shows 1. 